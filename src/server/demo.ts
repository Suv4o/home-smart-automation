...
export const SCENARIOS: Scenario[] = [
	{
		...
		build: (b) => ({
			...
			car: { soc: 58, at: b.at, ageMs: 4 * 60_000, minutesToFull: 96, chargeLimit: 80, locked: true },
	...
	},
	{
		...
		build: (b) => ({
			...
			car: { soc: 41, at: b.at, ageMs: 22 * 60_000, minutesToFull: 142, chargeLimit: 80, locked: true },
	...
	},
	{
		...
		build: (b) => ({
			...
			car: { soc: 52, at: b.at, ageMs: 3 * 3_600_000, minutesToFull: null, chargeLimit: 80, locked: false },
			decision: {
				action: "on",
				window: "solar",
	...
	},
	{
		...
		build: (b) => ({
			...
			car: { soc: 52, at: b.at, ageMs: 9 * 60_000, minutesToFull: null, chargeLimit: 80, locked: true },
			decision: {
				action: "off",
				window: "free",
	...
	},
	{
		...
		build: (b) => ({
			...
			charger: { on: false, powerW: 0 },
			car: { soc: 66, at: b.at, ageMs: 95 * 60_000, minutesToFull: null, chargeLimit: 80, locked: null },
	...
	},
	{
		...
		build: (b) => ({
			...
			charger: { on: false, powerW: 0 },
			car: { soc: 87, at: new Date(Date.now() - 9 * 3_600_000).toISOString(), ageMs: 9 * 3_600_000, minutesToFull: null, chargeLimit: 80, locked: false },
	...
	},
	{
		...
		build: (b) => ({
			...
			car: { soc: 24, at: b.at, ageMs: 2 * 60_000, minutesToFull: 205, chargeLimit: 80, locked: true },
